...
namespace lru
{
    ...
    public:
        ...
        size_t get_max_size() const { return maxSize_; }
        size_t get_elasticity() const { return elasticity_; }
        size_t get_max_allowed_size() const { return maxSize_ + elasticity_; }
        template <typename F>
