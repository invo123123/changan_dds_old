...
namespace proxy {
	...
	Basc_C2DmdPrmInfo_Proxy::Basc_C2DmdPrmInfo_Proxy(){

    }

	bool Basc_C2DmdPrmInfo_Proxy::init(std::string config) {
	...
	void Basc_C2DmdPrmInfo_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<C2DmdPrmInfo> Basc_C2DmdPrmInfo_Proxy::Get_C2DmdPrmInfo( size_t dds_rpc_time_out) {
		Msg<C2DmdPrmInfo> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_C2DmdPrmInfo_Proxy::Get_C2DmdPrmInfo dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_C2DmdPrmInfo_Get_C2DmdPrmInfo_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_C2DmdPrmInfo_Proxy::Get_C2DmdPrmInfo pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_C2DmdPrmInfo_Get_C2DmdPrmInfo_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_C2DmdPrmInfo_Get_C2DmdPrmInfo.return_;
	...
	Basc_C2DmdPrmInfo_Proxy& Basc_C2DmdPrmInfo_Proxy::get_instance()
	{
		static Basc_C2DmdPrmInfo_Proxy instance;
		return instance;
	}

	bool Basc_C2DmdPrmInfo_Proxy::is_init(){
