...
namespace skeleton {
    void on_carControl_Basc_RearWiperFltSts_request_data_available(int32_t reader, void* arg){
	...
	Basc_RearWiperFltSts_Skeleton::Basc_RearWiperFltSts_Skeleton(Basc_RearWiperFltSts_service_interface* service,std::string config):_config(config),_service(service){}

	void Basc_RearWiperFltSts_Skeleton::wait_client_online()
	{
    ...
    bool Basc_RearWiperFltSts_Skeleton::init() {
        using CarControlRSkeleton = com::changan::carControl::skeleton::CarControlRSkeleton;
	...
	dds_return_t Basc_RearWiperFltSts_Skeleton::send_reply(carControl_Car_Control_Reply* reply) {
