...
namespace skeleton {
    void on_carControl_Basc_FrntWiperFltSts_request_data_available(int32_t reader, void* arg){
	...
	Basc_FrntWiperFltSts_Skeleton::Basc_FrntWiperFltSts_Skeleton(Basc_FrntWiperFltSts_service_interface* service,std::string config):_config(config),_service(service){}

	void Basc_FrntWiperFltSts_Skeleton::wait_client_online()
	{
    ...
    bool Basc_FrntWiperFltSts_Skeleton::init() {
        using CarControlFLSkeleton = com::changan::carControl::skeleton::CarControlFLSkeleton;
	...
	dds_return_t Basc_FrntWiperFltSts_Skeleton::send_reply(carControl_Car_Control_Reply* reply) {
