...
namespace proxy {
	...
	Basc_FrntWiperStsInfo_Proxy::Basc_FrntWiperStsInfo_Proxy(){

    }

	bool Basc_FrntWiperStsInfo_Proxy::init(std::string config) {
	...
	void Basc_FrntWiperStsInfo_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<FWiperStsInfo> Basc_FrntWiperStsInfo_Proxy::Get_WiperStsInfo( size_t dds_rpc_time_out) {
		Msg<FWiperStsInfo> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_FrntWiperStsInfo_Proxy::Get_WiperStsInfo dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_FrntWiperStsInfo_Get_WiperStsInfo_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_FrntWiperStsInfo_Proxy::Get_WiperStsInfo pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_FrntWiperStsInfo_Get_WiperStsInfo_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_FrntWiperStsInfo_Get_WiperStsInfo.return_;
	...
	Basc_FrntWiperStsInfo_Proxy& Basc_FrntWiperStsInfo_Proxy::get_instance()
	{
		static Basc_FrntWiperStsInfo_Proxy instance;
		return instance;
	}

	bool Basc_FrntWiperStsInfo_Proxy::is_init(){
