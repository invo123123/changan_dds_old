...
namespace proxy {
	...
	Basc_RearWiperFltSts_Proxy::Basc_RearWiperFltSts_Proxy(){

    }

	bool Basc_RearWiperFltSts_Proxy::init(std::string config) {
	...
	void Basc_RearWiperFltSts_Proxy::wait_server_online()
	{
		CarControlRProxyGw::get_instance().wait_server_online();
	}
	Msg<RWiperFltSt> Basc_RearWiperFltSts_Proxy::Get_WiperFltSts( size_t dds_rpc_time_out) {
		Msg<RWiperFltSt> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_RearWiperFltSts_Proxy::Get_WiperFltSts dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_RearWiperFltSts_Get_WiperFltSts_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_RearWiperFltSts_Proxy::Get_WiperFltSts pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_RearWiperFltSts_Get_WiperFltSts_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_RearWiperFltSts_Get_WiperFltSts.return_;
	...
	Basc_RearWiperFltSts_Proxy& Basc_RearWiperFltSts_Proxy::get_instance()
	{
		static Basc_RearWiperFltSts_Proxy instance;
		return instance;
	}

	bool Basc_RearWiperFltSts_Proxy::is_init(){
