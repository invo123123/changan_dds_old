...
namespace proxy {
	...
	Basc_PhysicsStFrtGate_Proxy::Basc_PhysicsStFrtGate_Proxy(){

    }

	bool Basc_PhysicsStFrtGate_Proxy::init(std::string config) {
	...
	void Basc_PhysicsStFrtGate_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<uint8_t> Basc_PhysicsStFrtGate_Proxy::Get_PhySt( size_t dds_rpc_time_out) {
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_PhysicsStFrtGate_Proxy::Get_PhySt dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_PhysicsStFrtGate_Get_PhySt_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_PhysicsStFrtGate_Proxy::Get_PhySt pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_PhysicsStFrtGate_Get_PhySt_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_PhysicsStFrtGate_Get_PhySt.return_;
	...
	Basc_PhysicsStFrtGate_Proxy& Basc_PhysicsStFrtGate_Proxy::get_instance()
	{
		static Basc_PhysicsStFrtGate_Proxy instance;
		return instance;
	}

	bool Basc_PhysicsStFrtGate_Proxy::is_init(){
