...
namespace proxy {
	...
	Basc_BucSwtSts_Proxy::Basc_BucSwtSts_Proxy(){

    }

	bool Basc_BucSwtSts_Proxy::init(std::string config) {
	...
	void Basc_BucSwtSts_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<BucSwtSts> Basc_BucSwtSts_Proxy::Get_BucSwtSts( size_t dds_rpc_time_out) {
		Msg<BucSwtSts> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_BucSwtSts_Proxy::Get_BucSwtSts dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_BucSwtSts_Get_BucSwtSts_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_BucSwtSts_Proxy::Get_BucSwtSts pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_BucSwtSts_Get_BucSwtSts_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_BucSwtSts_Get_BucSwtSts.return_;
	...
	Basc_BucSwtSts_Proxy& Basc_BucSwtSts_Proxy::get_instance()
	{
		static Basc_BucSwtSts_Proxy instance;
		return instance;
	}

	bool Basc_BucSwtSts_Proxy::is_init(){
