...
namespace proxy {
	...
	Basc_PhysicsStWin_Proxy::Basc_PhysicsStWin_Proxy(){

    }

	bool Basc_PhysicsStWin_Proxy::init(std::string config) {
	...
	void Basc_PhysicsStWin_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<PhyStWinAll_Struct> Basc_PhysicsStWin_Proxy::Get_PhyStWinAll( size_t dds_rpc_time_out) {
		Msg<PhyStWinAll_Struct> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_PhysicsStWin_Proxy::Get_PhyStWinAll dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_PhysicsStWin_Get_PhyStWinAll_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_PhysicsStWin_Proxy::Get_PhyStWinAll pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_PhysicsStWin_Get_PhyStWinAll_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_PhysicsStWin_Get_PhyStWinAll.return_;
			_rpc_result.autoFreePtr = sp;
		}
		return _rpc_result;
	}
	Msg<ObjStTypeCurPosVITAll_Struct> Basc_PhysicsStWin_Proxy::Get_PosWinAll( size_t dds_rpc_time_out) {
		...
		if (DDS_RETCODE_OK != rc)
		{
			ASF_LOG_ERROR_ARGS("Basc_PhysicsStWin_Proxy::Get_PosWinAll dds_get_guid faild rc=[%d]", rc);
			_rpc_result.code = DDS_RPC_REMOTE_EX_UNSUPPORTED;
			return _rpc_result;
		}
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_PhysicsStWin_Get_PosWinAll_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_PhysicsStWin_Proxy::Get_PosWinAll pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_PhysicsStWin_Get_PosWinAll_Hash, _rpc_client_sn.low);
		auto _rpc_future = CarControlFLProxyGw::get_instance().call(_rpc_client_sn.low, _rpc_request);
		carControl_Car_Control_Request_free(_rpc_request, DDS_FREE_ALL);
		...
		_rpc_result.code = _rpc_ret->header.remoteEx;
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_PhysicsStWin_Get_PosWinAll.return_;
			_rpc_result.autoFreePtr = sp;
		}
		return _rpc_result;
	}
	...
	Basc_PhysicsStWin_Proxy& Basc_PhysicsStWin_Proxy::get_instance()
	{
		static Basc_PhysicsStWin_Proxy instance;
		return instance;
	}

	bool Basc_PhysicsStWin_Proxy::is_init(){
