...
namespace proxy {
	...
	Basc_CrashStsInfo_Proxy::Basc_CrashStsInfo_Proxy(){

    }

	bool Basc_CrashStsInfo_Proxy::init(std::string config) {
	...
	void Basc_CrashStsInfo_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<CrashStsInfo> Basc_CrashStsInfo_Proxy::Get_CrashStsInfo( size_t dds_rpc_time_out) {
		Msg<CrashStsInfo> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_CrashStsInfo_Proxy::Get_CrashStsInfo dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_CrashStsInfo_Get_CrashStsInfo_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_CrashStsInfo_Proxy::Get_CrashStsInfo pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_CrashStsInfo_Get_CrashStsInfo_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_CrashStsInfo_Get_CrashStsInfo.return_;
	...
	Basc_CrashStsInfo_Proxy& Basc_CrashStsInfo_Proxy::get_instance()
	{
		static Basc_CrashStsInfo_Proxy instance;
		return instance;
	}

	bool Basc_CrashStsInfo_Proxy::is_init(){
