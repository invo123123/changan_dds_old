...
namespace Window {
namespace skeleton {
    void on_carControl_Basc_PhysicsStWin_request_data_available(int32_t reader, void* arg){
	...
	Basc_PhysicsStWin_Skeleton::Basc_PhysicsStWin_Skeleton(Basc_PhysicsStWin_service_interface* service,std::string config):_config(config),_service(service){}

	void Basc_PhysicsStWin_Skeleton::wait_client_online()
	{
    ...
    bool Basc_PhysicsStWin_Skeleton::init() {
        using CarControlFLSkeleton = com::changan::carControl::skeleton::CarControlFLSkeleton;
	...
	dds_return_t Basc_PhysicsStWin_Skeleton::send_reply(carControl_Car_Control_Reply* reply) {
