...
namespace skeleton {
    void on_carControl_Sys_TotalMilg_request_data_available(int32_t reader, void* arg){
	...
	Sys_TotalMilg_Skeleton::Sys_TotalMilg_Skeleton(Sys_TotalMilg_service_interface* service,std::string config):_config(config),_service(service){}

	void Sys_TotalMilg_Skeleton::wait_client_online()
	{
    ...
    bool Sys_TotalMilg_Skeleton::init() {
        using CarControlFLSkeleton = com::changan::carControl::skeleton::CarControlFLSkeleton;
	...
	dds_return_t Sys_TotalMilg_Skeleton::send_reply(carControl_Car_Control_Reply* reply) {
