...
namespace proxy {
	...
	Basc_MirrLaneLEDFltSts_Proxy::Basc_MirrLaneLEDFltSts_Proxy(){

    }

	bool Basc_MirrLaneLEDFltSts_Proxy::init(std::string config) {
	...
	void Basc_MirrLaneLEDFltSts_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<LaneLedFltSt> Basc_MirrLaneLEDFltSts_Proxy::Get_LaneLEDFltSts( size_t dds_rpc_time_out) {
		Msg<LaneLedFltSt> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_MirrLaneLEDFltSts_Proxy::Get_LaneLEDFltSts dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_MirrLaneLEDFltSts_Get_LaneLEDFltSts_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_MirrLaneLEDFltSts_Proxy::Get_LaneLEDFltSts pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_MirrLaneLEDFltSts_Get_LaneLEDFltSts_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_MirrLaneLEDFltSts_Get_LaneLEDFltSts.return_;
	...
	Basc_MirrLaneLEDFltSts_Proxy& Basc_MirrLaneLEDFltSts_Proxy::get_instance()
	{
		static Basc_MirrLaneLEDFltSts_Proxy instance;
		return instance;
	}

	bool Basc_MirrLaneLEDFltSts_Proxy::is_init(){
