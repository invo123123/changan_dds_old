...
namespace proxy {
	...
	Basc_LogicStLock_Proxy::Basc_LogicStLock_Proxy(){

    }

	bool Basc_LogicStLock_Proxy::init(std::string config) {
	...
	void Basc_LogicStLock_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<LockStAll_Struct> Basc_LogicStLock_Proxy::Get_LocStAll( size_t dds_rpc_time_out) {
		Msg<LockStAll_Struct> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_LogicStLock_Proxy::Get_LocStAll dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_LogicStLock_Get_LocStAll_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_LogicStLock_Proxy::Get_LocStAll pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_LogicStLock_Get_LocStAll_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_LogicStLock_Get_LocStAll.return_;
	...
	Basc_LogicStLock_Proxy& Basc_LogicStLock_Proxy::get_instance()
	{
		static Basc_LogicStLock_Proxy instance;
		return instance;
	}

	bool Basc_LogicStLock_Proxy::is_init(){
