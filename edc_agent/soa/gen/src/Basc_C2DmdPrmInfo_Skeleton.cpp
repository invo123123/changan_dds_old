...
namespace C2Demand {
namespace skeleton {
    void on_carControl_Basc_C2DmdPrmInfo_request_data_available(int32_t reader, void* arg){
	...
	Basc_C2DmdPrmInfo_Skeleton::Basc_C2DmdPrmInfo_Skeleton(Basc_C2DmdPrmInfo_service_interface* service,std::string config):_config(config),_service(service){}

	void Basc_C2DmdPrmInfo_Skeleton::wait_client_online()
	{
    ...
    bool Basc_C2DmdPrmInfo_Skeleton::init() {
        using CarControlFLSkeleton = com::changan::carControl::skeleton::CarControlFLSkeleton;
	...
	dds_return_t Basc_C2DmdPrmInfo_Skeleton::send_reply(carControl_Car_Control_Reply* reply) {
