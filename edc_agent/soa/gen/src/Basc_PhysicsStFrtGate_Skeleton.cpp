...
namespace Door {
namespace skeleton {
    void on_carControl_Basc_PhysicsStFrtGate_request_data_available(int32_t reader, void* arg){
	...
	Basc_PhysicsStFrtGate_Skeleton::Basc_PhysicsStFrtGate_Skeleton(Basc_PhysicsStFrtGate_service_interface* service,std::string config):_config(config),_service(service){}

	void Basc_PhysicsStFrtGate_Skeleton::wait_client_online()
	{
    ...
    bool Basc_PhysicsStFrtGate_Skeleton::init() {
        using CarControlFLSkeleton = com::changan::carControl::skeleton::CarControlFLSkeleton;
	...
	dds_return_t Basc_PhysicsStFrtGate_Skeleton::send_reply(carControl_Car_Control_Reply* reply) {
