...
namespace proxy {
	...
	Basc_BLEPhyKeySer_Proxy::Basc_BLEPhyKeySer_Proxy(){

    }

	bool Basc_BLEPhyKeySer_Proxy::init(std::string config) {
	...
	void Basc_BLEPhyKeySer_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<BLEPhyKeyBascInfo> Basc_BLEPhyKeySer_Proxy::Get_BLEPhyKeyInfo( size_t dds_rpc_time_out) {
		Msg<BLEPhyKeyBascInfo> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_BLEPhyKeySer_Proxy::Get_BLEPhyKeyInfo dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_BLEPhyKeySer_Get_BLEPhyKeyInfo_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_BLEPhyKeySer_Proxy::Get_BLEPhyKeyInfo pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_BLEPhyKeySer_Get_BLEPhyKeyInfo_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_BLEPhyKeySer_Get_BLEPhyKeyInfo.return_;
	...
	Basc_BLEPhyKeySer_Proxy& Basc_BLEPhyKeySer_Proxy::get_instance()
	{
		static Basc_BLEPhyKeySer_Proxy instance;
		return instance;
	}

	bool Basc_BLEPhyKeySer_Proxy::is_init(){
