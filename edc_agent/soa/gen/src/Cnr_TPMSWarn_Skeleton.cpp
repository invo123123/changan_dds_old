...
namespace Tyre {
namespace skeleton {
    void on_carControl_Cnr_TPMSWarn_request_data_available(int32_t reader, void* arg){
	...
	Cnr_TPMSWarn_Skeleton::Cnr_TPMSWarn_Skeleton(Cnr_TPMSWarn_service_interface* service,std::string config):_config(config),_service(service){}

	void Cnr_TPMSWarn_Skeleton::wait_client_online()
	{
    ...
    bool Cnr_TPMSWarn_Skeleton::init() {
        using CarControlFLSkeleton = com::changan::carControl::skeleton::CarControlFLSkeleton;
	...
	dds_return_t Cnr_TPMSWarn_Skeleton::send_reply(carControl_Car_Control_Reply* reply) {
