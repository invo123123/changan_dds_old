...
namespace proxy {
	...
	Basc_BattHVSts_Proxy::Basc_BattHVSts_Proxy(){

    }

	bool Basc_BattHVSts_Proxy::init(std::string config) {
	...
	void Basc_BattHVSts_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<BattHVSts> Basc_BattHVSts_Proxy::Get_BattHVSts( size_t dds_rpc_time_out) {
		Msg<BattHVSts> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_BattHVSts_Proxy::Get_BattHVSts dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_BattHVSts_Get_BattHVSts_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_BattHVSts_Proxy::Get_BattHVSts pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_BattHVSts_Get_BattHVSts_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_BattHVSts_Get_BattHVSts.return_;
	...
	Basc_BattHVSts_Proxy& Basc_BattHVSts_Proxy::get_instance()
	{
		static Basc_BattHVSts_Proxy instance;
		return instance;
	}

	bool Basc_BattHVSts_Proxy::is_init(){
