...
namespace proxy {
	...
	Basc_FrntWiperFltSts_Proxy::Basc_FrntWiperFltSts_Proxy(){

    }

	bool Basc_FrntWiperFltSts_Proxy::init(std::string config) {
	...
	void Basc_FrntWiperFltSts_Proxy::wait_server_online()
	{
		CarControlFLProxyGw::get_instance().wait_server_online();
	}
	Msg<FWiperFltSt> Basc_FrntWiperFltSts_Proxy::Get_WiperFltSts( size_t dds_rpc_time_out) {
		Msg<FWiperFltSt> _rpc_result;
		...
		{
			ASF_LOG_ERROR_ARGS("Basc_FrntWiperFltSts_Proxy::Get_WiperFltSts dds_get_guid faild rc=[%d]", rc);
		...
		_rpc_request->data._d = carControl_Car_Control_Basc_FrntWiperFltSts_Get_WiperFltSts_Hash;
		ASF_LOG_DEBUG_ARGS("Basc_FrntWiperFltSts_Proxy::Get_WiperFltSts pre call, hashId=[%d], reqId=[%d]", carControl_Car_Control_Basc_FrntWiperFltSts_Get_WiperFltSts_Hash, _rpc_client_sn.low);
		...
		if (_rpc_result.code == DDS_RPC_REMOTE_EX_OK) {
			_rpc_result.data = _rpc_ret->data._u.Basc_FrntWiperFltSts_Get_WiperFltSts.return_;
	...
	Basc_FrntWiperFltSts_Proxy& Basc_FrntWiperFltSts_Proxy::get_instance()
	{
		static Basc_FrntWiperFltSts_Proxy instance;
		return instance;
	}

	bool Basc_FrntWiperFltSts_Proxy::is_init(){
