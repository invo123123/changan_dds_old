...
namespace skeleton {
    void on_carControl_Cnr_FrntWiperCtrl_request_data_available(int32_t reader, void* arg){
	...
	Cnr_FrntWiperCtrl_Skeleton::Cnr_FrntWiperCtrl_Skeleton(Cnr_FrntWiperCtrl_service_interface* service,std::string config):_config(config),_service(service){}

	void Cnr_FrntWiperCtrl_Skeleton::wait_client_online()
	{
    ...
    bool Cnr_FrntWiperCtrl_Skeleton::init() {
        using CarControlFLSkeleton = com::changan::carControl::skeleton::CarControlFLSkeleton;
	...
	dds_return_t Cnr_FrntWiperCtrl_Skeleton::send_reply(carControl_Car_Control_Reply* reply) {
