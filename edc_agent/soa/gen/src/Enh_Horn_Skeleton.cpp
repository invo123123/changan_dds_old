...
namespace Horn {
namespace skeleton {
    void on_carControl_Enh_Horn_request_data_available(int32_t reader, void* arg){
	...
	Enh_Horn_Skeleton::Enh_Horn_Skeleton(Enh_Horn_service_interface* service,std::string config):_config(config),_service(service){}

	void Enh_Horn_Skeleton::wait_client_online()
	{
	...
	dds_return_t Enh_Horn_Skeleton::send_reply(carControl_Car_Control_Reply* reply) {
