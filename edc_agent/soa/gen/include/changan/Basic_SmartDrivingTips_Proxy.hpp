...
*****************************************************************/
#ifndef Basic_SmartDrivingTips_Proxy_HPP
#define Basic_SmartDrivingTips_Proxy_HPP
#include <string.h>
#include <future>
#include <chrono>
	...
	namespace events {
        class Basic_SmartDrivingTips_Ntf_SmartDriveTips{
			...
			private:
			    ...
			    std::string event_name="Ntf_SmartDriveTips";
        };
	}
	class Basic_SmartDrivingTips_Proxy : IBaseProxy,IBaseWait, public ProviderMatchedStatusHandler, public dds_link_count{
		public:
		    static Basic_SmartDrivingTips_Proxy& get_instance();
		...
		private:
            ...
            dds_rpc_handle_t dds_Ntf_SmartDriveTips_handle = { -1,-1,-1 };

            bool init_flag = false;
            std::mutex init_mutex;

			Basic_SmartDrivingTips_Proxy();
			~Basic_SmartDrivingTips_Proxy();

			Basic_SmartDrivingTips_Proxy(const Basic_SmartDrivingTips_Proxy& signal);

			const Basic_SmartDrivingTips_Proxy& operator=(const Basic_SmartDrivingTips_Proxy& signal);
	};
}
}
}
