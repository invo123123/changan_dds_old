...
*****************************************************************/
#ifndef CAR_CONTROL_FR_SKELETON_HPP
#define CAR_CONTROL_FR_SKELETON_HPP
...
namespace com {
	namespace changan {
		namespace carControl {
			namespace skeleton {
				extern void on_carControl_fr_request_data_available(int32_t reader, void* arg);

				class CarControlFRSkeleton:public IBaseWait
				{
				public:
					static CarControlFRSkeleton& get_instance();
				...
				private:
					...
					std::string config;
					CarControlFRSkeleton();
					CarControlFRSkeleton(const CarControlFRSkeleton& signal);
					const CarControlFRSkeleton& operator=(const CarControlFRSkeleton& signal);
				};
			}
		}
	}
