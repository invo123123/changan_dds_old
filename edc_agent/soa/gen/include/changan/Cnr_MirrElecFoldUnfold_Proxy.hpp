...
*****************************************************************/
#ifndef Cnr_MirrElecFoldUnfold_Proxy_HPP
#define Cnr_MirrElecFoldUnfold_Proxy_HPP
#include <string.h>
#include <future>
#include <chrono>
...
namespace proxy {
	...
	extern void on_carControl_Cnr_MirrElecFoldUnfold_reply_data_available(int32_t reader, void* arg);
	class Cnr_MirrElecFoldUnfold_Proxy : IBaseProxy,IBaseWait, public ProviderMatchedStatusHandler{
		public:
		    static Cnr_MirrElecFoldUnfold_Proxy& get_instance();
			...
			Msg<ResponseInfo> RR_MirrFoldUnfoldCrl(const uint8_t &SwtStCmd,const RequestInfo &RequestInfo) {
				return this->RR_MirrFoldUnfoldCrl<DEFAULT_TIMEOUT>(SwtStCmd,RequestInfo);
			}
			template<size_t TIMEOUT>
			Msg<ResponseInfo> RR_MirrFoldUnfoldCrl(const uint8_t &SwtStCmd,const RequestInfo &RequestInfo) {
				return this->RR_MirrFoldUnfoldCrl(SwtStCmd,RequestInfo, TIMEOUT);
			}
		...
		private:
			...
			Msg<ResponseInfo> RR_MirrFoldUnfoldCrl(const uint8_t &SwtStCmd,const RequestInfo &RequestInfo, size_t dds_rpc_time_out);
			...
			const uint16_t service_id = 1586;

			Cnr_MirrElecFoldUnfold_Proxy();
			~Cnr_MirrElecFoldUnfold_Proxy();

			Cnr_MirrElecFoldUnfold_Proxy(const Cnr_MirrElecFoldUnfold_Proxy& signal);

			const Cnr_MirrElecFoldUnfold_Proxy& operator=(const Cnr_MirrElecFoldUnfold_Proxy& signal);
	};
}
}
}
